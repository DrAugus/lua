function parse_cpp_table(table_data)
	local my_table = nil

	-- table_data is nil or is {}, this empty table
	if table_data == nil or next(table_data) == nil then
		my_table = nil
	else
		my_table = {}
...
if  not ok  then
    print("the script has been run: ", rt, ", result:", e)
else
    print("win twice")
end
